...
if 'devices' not in st.session_state:
    st.session_state.devices = [
        {"id": 1, "name": "Front Door Camera", "type": "camera", "status": "active", "location": "Front Entrance", "battery": 85},
        {"id": 2, "name": "Motion Sensor - Living Room", "type": "sensor", "status": "active", "location": "Living Room", "battery": 92},
        {"id": 3, "name": "Smart Lock - Main Door", "type": "lock", "status": "active", "location": "Main Door", "battery": 78},
        {"id": 4, "name": "Window Sensor - Bedroom", "type": "sensor", "status": "inactive", "location": "Bedroom", "battery": 45},
        {"id": 5, "name": "Garage Camera", "type": "camera", "status": "active", "location": "Garage", "battery": 95},
        {"id": 6, "name": "Back Door Sensor", "type": "sensor", "status": "active", "location": "Back Door", "battery": 67}
    ]

if 'alerts' not in st.session_state:
    st.session_state.alerts = [
        {"id": 1, "type": "warning", "message": "Motion detected at Front Entrance", "timestamp": datetime.now() - timedelta(minutes=5), "severity": "medium"},
        {"id": 2, "type": "critical", "message": "Unauthorized access attempt at Main Door", "timestamp": datetime.now() - timedelta(minutes=15), "severity": "high"},
        {"id": 3, "type": "info", "message": "Battery low on Window Sensor - Bedroom", "timestamp": datetime.now() - timedelta(hours=1), "severity": "low"}
    ]
